...
const TRAINING_POSITIONS = [
  ...
  {
    code: 'FRONT_VERSATILE',
    nameZh: '前厅通岗员工',
    nameEn: 'Front-of-house versatile employee',
    nameFr: 'Salle polyvalent',
    parentCode: 'FRONT_ASSISTANT',
    sortOrder: 24,
  },
  {
  ...
  },
  {
    ...
    nameFr: 'Cuisine Manager',
    parentCode: 'KITCHEN',
    sortOrder: 31,
  },
  {
    code: 'KITCHEN_ASSISTANT',
    nameZh: '厨房助理',
    nameEn: 'Kitchen Assistant',
    nameFr: 'Assistant cuisine',
    parentCode: 'KITCHEN_MANAGER',
    sortOrder: 32,
  },
  {
    code: 'KITCHEN_DISHWASHING',
    nameZh: '洗碗',
    nameEn: 'Dishwasher',
    nameFr: 'Plonge',
    parentCode: 'KITCHEN_ASSISTANT',
    sortOrder: 42,
  },
  {
    code: 'KITCHEN_NOODLE_STATION',
    nameZh: '面区',
  ...
  {
    code: 'KITCHEN_VERSATILE',
    nameZh: '厨房通岗',
    nameEn: 'Kitchen versatile employee',
    nameFr: 'Polyvalent cuisine',
    parentCode: 'KITCHEN_ASSISTANT',
    sortOrder: 44,
  },
  {
...
const TRAINING_JOB_ROLE_POSITIONS = [
  ...
  },
  {
    ...
    positionCode: 'KITCHEN_ASSISTANT',
    includeDescendants: true,
    grantsAllPositions: false,
  },
  {
    jobRole: 'front-of-house',
    positionCode: 'FRONT_OF_HOUSE',
    includeDescendants: true,
    grantsAllPositions: false,
  },
  {
    jobRole: 'back-of-house',
    positionCode: 'KITCHEN',
    includeDescendants: true,
    grantsAllPositions: false,
  },
  {
  ...
  },
  {
    ...
    positionCode: 'KITCHEN_DISHWASHING',
    includeDescendants: false,
    grantsAllPositions: false,
  },
  {
    jobRole: 'back-noodle',
    positionCode: 'KITCHEN_NOODLE_STATION',
    includeDescendants: false,
    grantsAllPositions: false,
  },
  {
    jobRole: 'back-hot-appetizer',
    positionCode: 'KITCHEN_HOT_APPETIZERS',
    includeDescendants: false,
    grantsAllPositions: false,
  },
  {
    jobRole: 'back-cold-appetizer',
    positionCode: 'KITCHEN_COLD_APPETIZERS',
    includeDescendants: false,
    grantsAllPositions: false,
  },
  {
    jobRole: 'back-rice',
    positionCode: 'KITCHEN_RICE',
    includeDescendants: false,
    grantsAllPositions: false,
  },
];
