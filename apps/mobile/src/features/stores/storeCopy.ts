...
export const STORE_COPY = {
  zh: {
    ...
    deactivateEmployeeBody: "停用后该员工将无法登录，并会从当前团队列表移除；下单、培训等历史记录会保留。",
    deactivateEmployeeTitle: "停用这个员工？",
    employeeDeactivated: "员工已停用。",
    employeeDeactivateError: "停用员工失败。",
    empty: "暂无可管理门店。",
    error: "门店数据加载失败。",
    filterAll: "全部岗位",
    imageFallback: "ZHAO",
  ...
  en: {
    ...
    deactivateEmployeeBody:
      "This employee will no longer be able to sign in and will be removed from the team list. Order and training history will be kept.",
    deactivateEmployeeTitle: "Deactivate this employee?",
    employeeDeactivated: "Employee deactivated.",
    employeeDeactivateError: "Employee could not be deactivated.",
  ...
  fr: {
    ...
    deactivateEmployeeBody:
      "Cet employé ne pourra plus se connecter et sera retiré de l’équipe. Son historique de commandes et de formation sera conservé.",
    deactivateEmployeeTitle: "Désactiver cet employé ?",
    employeeDeactivated: "Employé désactivé.",
    employeeDeactivateError: "Impossible de désactiver l’employé.",
...
export const INVITE_PARTNER_COPY = {
  zh: {
    ...
    error: "邀请发送失败，请稍后重试。",
    errorEmailExists: "该邮箱已存在账号，无法发送邀请。",
    errorPermission: "当前岗位无权邀请该员工。",
    hint: "邮件将发送到伙伴邮箱，对方填写姓名和密码后即可登录。",
    loadingRoles: "正在加载岗位…",
    role: "岗位",
    roleRequired: "请选择岗位。",
    send: "发送邀请",
  ...
  en: {
    ...
    errorEmailExists: "This email already belongs to an account.",
    errorPermission: "Your position cannot invite this employee.",
    hint: "The partner will receive an email to enter their name and set a password before signing in.",
    loadingRoles: "Loading positions…",
    role: "Position",
    roleRequired: "Choose a position.",
  ...
  fr: {
    email: "E-mail du partenaire",
    emailInvalid: "Saisissez une adresse e-mail valide.",
    emailPlaceholder: "partenaire@example.com",
    error: "L’invitation n’a pas pu être envoyée. Réessayez plus tard.",
    errorEmailExists: "Cette adresse e-mail appartient déjà à un compte.",
    errorPermission: "Votre poste ne peut pas inviter cet employé.",
    hint: "Le partenaire recevra un e-mail pour renseigner son nom et choisir un mot de passe avant de se connecter.",
    loadingRoles: "Chargement des postes…",
    role: "Poste",
    roleRequired: "Choisissez un poste.",
