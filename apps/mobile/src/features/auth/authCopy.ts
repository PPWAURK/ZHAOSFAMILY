...
const COMMON_ROLES_ZH: RoleOption[] = [
  ...
  { value: "back-manager", label: "厨房经理", description: "负责厨房出品与厨房协作" },
  { value: "front-assistant", label: "前厅助理", description: "协助前厅排班、服务和培训" },
  { value: "back-assistant", label: "厨房助理", description: "协助厨房备料、出餐和培训" },
  { value: "front-of-house", label: "前厅", description: "服务、迎宾、门店体验" },
  { value: "back-of-house", label: "厨房", description: "备料、出餐、厨房协作" },
];
