...
export const DASHBOARD_COPY = {
  ...
  en: {
    ...
    newsViewFullscreen: "View attachment fullscreen",
  ...
  fr: {
    ...
    newsViewFullscreen: "Voir la pièce jointe en plein écran",
    ...
    loadingModule: "Ouverture de la page...",
