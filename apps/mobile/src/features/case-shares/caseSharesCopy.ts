...
export const CASE_SHARES_COPY: Record<AuthLanguage, CaseSharesCopy> = {
  ...
  en: {
    ...
    mineTitle: "My shares",
    mineIntro: "Review your submissions, approval status, and marketing feedback.",
    publish: "Share a gem",
    ...
    reviewNoteLabel: "Marketing feedback",
    delete: "Delete",
    deleting: "Deleting…",
    ...
    statusLabels: {
      pending: "Pending",
      approved: "Public",
      rejected: "Not selected for display",
    },
  },
  ...
  fr: {
    ...
    statusLabels: {
      pending: "En attente",
      approved: "Public",
      rejected: "Non retenu pour affichage",
    },
  },
};
