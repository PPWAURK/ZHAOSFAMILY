export const SUPPLIERS_COPY = {
  zh: {
    ...
    colSpecification: "规格",
    caseSizeLabel: "一箱有",
    caseSizePlaceholder: "留空",
    caseSizeUnitFallback: "个",
    colImage: "图片",
    colActions: "操作",
    ...
    imagePlaceholder: "支持 JPG、PNG、WebP",
    imageUpload: "上传图片",
    imageChange: "更换",
    imageClear: "清空",
    imageEmpty: "未上传",
    imagePresent: "已上传",
    imageInvalidType: "请选择 JPG、PNG 或 WebP 格式的图片。",
    ...
    validation: {
      ...
      caseSizeInvalid: "每箱数量必须是大于 0 的整数。",
    },
    currencySymbol: "€",
    truePill: "是",
    falsePill: "否",
  ...
  en: {
    ...
    caseSizeLabel: "1 box =",
    caseSizePlaceholder: "Optional",
    caseSizeUnitFallback: "units",
    colImage: "Image",
    colActions: "Actions",
    ...
    imagePlaceholder: "JPG, PNG or WebP",
    imageUpload: "Upload",
    imageChange: "Change",
    imageClear: "Clear",
    imageEmpty: "No image",
    imagePresent: "Uploaded",
    imageInvalidType: "Please choose a JPG, PNG, or WebP image.",
    ...
    validation: {
      ...
      caseSizeInvalid: "The box quantity must be a whole number greater than 0.",
    },
    currencySymbol: "€",
    truePill: "Yes",
    falsePill: "No",
  ...
  fr: {
    ...
    caseSizeLabel: "1 carton =",
    caseSizePlaceholder: "Facultatif",
    caseSizeUnitFallback: "unités",
    colImage: "Image",
    colActions: "Actions",
    ...
    imagePlaceholder: "JPG, PNG ou WebP",
    imageUpload: "Importer",
    imageChange: "Changer",
    imageClear: "Vider",
    imageEmpty: "Aucune image",
    imagePresent: "Importée",
    imageInvalidType: "Veuillez choisir une image JPG, PNG ou WebP.",
    imageUploadError: "Échec de l'import de l'image. Réessayez.",
    ...
    validation: {
      ...
      caseSizeInvalid: "La quantité par carton doit être un entier supérieur à 0.",
    },
    currencySymbol: "€",
    truePill: "Oui",
    falsePill: "Non",
