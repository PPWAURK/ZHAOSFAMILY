...
import { TrainingBadgeSvg } from "@/features/training/components/badges/TrainingBadgeSvg";
import { buildBadgeImageUrl } from "@/shared/api/api-client";
import {
  fetchBadgeSvgFiles,
  updateBadgeImage,
} from "@/features/training/services/trainingBadgeApi";
...
export function TrainingBadgeDetailModal({
  ...
  const handleSelect = useCallback(
    async (fileName: string) => {
      ...
      try {
        await updateBadgeImage(String(badge.id), fileName);
      } catch {
        setSelectedFile(badge.imageFileName ?? null);
      } finally {
        setSaving(false);
