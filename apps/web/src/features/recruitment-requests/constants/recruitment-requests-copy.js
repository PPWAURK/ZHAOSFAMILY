...
export const RECRUITMENT_REQUEST_COPY = {
  zh: {
    ...
    send: {
      ...
      selectAll: "全选",
      deleteSelected: "删除选中",
      deleteSelectedConfirm: "确定要删除选中的 {count} 条招聘请求吗？",
      deleteSelectedSuccess: "已删除 {count} 条招聘请求。",
      deleteSelectedError: "批量删除失败，请稍后重试。",
    },
  },
  en: {
    topFamily: "FAMILY",
    ...
    send: {
      ...
      deleteSelectedConfirm: "Delete {count} selected requests?",
      deleteSelectedSuccess: "{count} requests deleted.",
      deleteSelectedError: "Batch delete failed, please try again.",
    },
  },
  fr: {
    topFamily: "FAMILY",
    ...
    send: {
      ...
      deleteSelectedConfirm: "Supprimer {count} demande(s) sélectionnée(s) ?",
      deleteSelectedSuccess: "{count} demande(s) supprimée(s).",
      deleteSelectedError: "Échec de la suppression groupée, réessayez.",
    },
  },
};
